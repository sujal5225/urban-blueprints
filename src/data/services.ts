...
export const servicesData: Record<string, ServiceDetail> = {
    ...
    sections: [
      {
        ...
        items: [
          { title: "Planning", description: "Transportation engineers analyse demographic, economic, and environmental factors to develop long-term transportation plans that align with the needs and growth of communities. They evaluate existing transportation infrastructure and identify areas for improvement, considering factors such as traffic congestion, road capacity, and public transportation options.", image: "/images/services/transportation/planning.webp", details: ["Demographic and land-use analysis to forecast travel demand", "Traffic volume studies and Level of Service (LOS) assessments", "Multi-modal corridor planning integrating bus, rail, and active travel", "Environmental impact screening and route feasibility studies", "Long-range transportation plan (LRTP) development"] },

          { title: "Design", description: "Transportation engineers translate transportation plans into concrete designs for roads, bridges, highways, railways, airports, and other transportation facilities. They consider traffic flow, safety, environmental impact, and aesthetic appeal.", image: "/images/services/transportation/design.webp", details: ["Geometric road alignment and profile design to AASHTO standards", "Interchange and intersection control design for optimal traffic flow", "Pavement structure design using CBR and mechanistic-empirical methods", "Drainage and stormwater management system integration", "Signage, marking, and lighting plans for road safety"] },
          { title: "Construction", description: "Transportation engineers collaborate with construction teams to oversee the safe and efficient construction of transportation infrastructure projects. They monitor the quality of materials and craft, ensure adherence to design specifications, and manage project schedules and budgets.", image: "/images/services/transportation/construction.webp", details: ["Contractor oversight and quality assurance testing during earthworks", "Material testing and project specifications", "Progress schedule monitoring using Primavera P6 or MS Project", "Construction site safety audits", "Contract administration and change order management"] },
  ...
  "environmental-engineering": {
    ...
    description: "We evaluate and address the ecological impacts of development projects.",
